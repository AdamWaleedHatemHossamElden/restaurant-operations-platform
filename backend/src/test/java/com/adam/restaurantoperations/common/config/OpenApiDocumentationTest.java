...
class OpenApiDocumentationTest {
    ...
    void generatedDocumentDefinesBearerSchemeForAuthenticatedOperations() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$.paths['/api/v1/payments'].get.security[0].bearerAuth").isArray())
                .andExpect(jsonPath("$.paths['/api/v1/payments/orders/{orderId}'].post").exists())
                .andExpect(jsonPath("$.paths['/api/v1/payments/{paymentId}/reconciliation'].post").exists())
                .andExpect(jsonPath("$.paths['/api/v1/invoices'].get.security[0].bearerAuth").isArray())
                .andExpect(jsonPath("$.paths['/api/v1/invoices/orders/{orderId}'].post").exists())

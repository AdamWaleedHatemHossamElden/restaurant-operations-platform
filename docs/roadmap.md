...
8. **Phase 8 — Payments and invoices:** current unmerged work on `phase-8-payments-invoices`, including confirmed EUR payment recording, partial and split settlement, idempotency and overpayment protection, immutable reconciliation and invoices, audit, and responsive settlement views. Provider integration, refunds, taxes, discounts, and tips remain later work.
